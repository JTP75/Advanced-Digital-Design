...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins adder_0/k] [get_bd_pins axi_regmap_0/REG3_OUT] [get_bd_pins ila_0/probe5]
  connect_bd_net -net REG2_IN_0_1 [get_bd_ports btn] [get_bd_pins axi_regmap_0/REG2_IN] [get_bd_pins ila_0/probe3]
  connect_bd_net -net adder_0_C_out [get_bd_pins adder_0/C_out] [get_bd_pins axi_regmap_0/REG3_IN] [get_bd_pins ila_0/probe6]
