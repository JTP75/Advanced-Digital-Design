...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net multiplier_0_R [get_bd_pins multiplier_0/R] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net multiplier_0_done [get_bd_pins axi_regmap_0/REG3_IN] [get_bd_pins multiplier_0/done]
