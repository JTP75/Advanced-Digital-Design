...
architecture state_behav of mips_controller is
    ...
    type state_t is (
        ...
        instr_decode,               -- read instr
            ...
            jcomp,                  -- completion of jump instr
...
begin
    ...
    PCwro <= PCwr OR (PCwr_cond AND ALU_z);
    ...
    begin
        if (    state=instr_fetch or
                state=compute_mem_addr ) then       -- do unsigned addition for instr fetching and mem address computation
            aluop <= "0101";
        elsif opcode="000000" then
            case funct is
