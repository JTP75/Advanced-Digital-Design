...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlslice_v1_0_1 -L xlconcat_v2_1_1 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CPU_mem xil_defaultlib.CPU_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CPU_mem -key {Behavioral:sim_1:Functional:CPU_mem} -tclbatch cmd.tcl -protoinst "protoinst_files/CPU_mips.protoinst" -protoinst "protoinst_files/CPU_mem.protoinst" -protoinst "protoinst_files/CPU_mips.protoinst" -protoinst "protoinst_files/CPU_TL.protoinst" -protoinst "protoinst_files/CPU_mips.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xlslice_v1_0_1 xlconcat_v2_1_1)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CPU_mem.wdb xsim.dir)
